...
const AxiosWithAsync = () => {
  ...
  const handleAddUser = async () => {
    try {
        const response = await axios.post("https://user-dummy-api.onrender.com/api/users", userDetails.addModal, 
            {
                headers: {
  ...
  const handleUpdateUser = async  () => {
    try {
        const response = await axios.put(`https://user-dummy-api.onrender.com/api/users/${userDetails.editModal._id}`,
  ...
  const userDelete = async (selectedUserID) => {
    try {
        const response = await axios.delete(`https://user-dummy-api.onrender.com/api/users/${selectedUserID}`)
